...
C ---       Loop through the 24 different options that are flagged
            DO I = 1, 24
...
C --- Initialize logicals for use of BETA options for low-wind-speed 
C     modifications.
      L_LowWind1 = .FALSE.
      L_LowWind2 = .FALSE.
      L_LowWind3 = .FALSE.
C --- Include user-specified LowWind variables
      L_UserSVmin = .FALSE.
      L_UserWSmin = .FALSE.
      L_UserFRANmax = .FALSE.
